...
public class Util
{
   ...
   public static void fillTriangle(Graphics g, int ax, int ay, int bx, int by, int cx, int cy) {
      X[0] = ax; X[1] = bx; X[2] = cx;
      Y[0] = ay; Y[1] = by; Y[2] = cy;
      g.fillPolygon(X, Y, 3);
   }
   ...
   public static int getAscii(int key, int modifiers) {
