...
public class ZBufferer {
   ...
   protected boolean isAlwaysInFront() {
      return alwaysInFront;
   }

   protected void setAlwaysInFront(boolean state) {
      alwaysInFront = state;
   }
   ...
   protected static int pack(int r, int g, int b, int a) {
