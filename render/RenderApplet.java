...
*/
  ...
  int getKey(KeyEvent e) {
     ...
     int _char = e.getKeyChar();
     if (_char == 65535) _code += 128;
     return _code;
  }
  ...
  private void addInputListeners()
  {
    addKeyListener(new KeyAdapter()
    {
      public void keyPressed(KeyEvent e)
      {
        ...
        keyDown(newEvent(e), getKey(e));
      }

      public void keyReleased(KeyEvent e)
      {
        //keyUp(newEvent(e), e.getKeyCode());
        keyUp(newEvent(e), getKey(e));
      }
    });
  ...
  Event newEvent(KeyEvent e)
  {
    ...
    return new Event(null, 0, 0, 0, 0, getKey(e), e.getModifiers());
  }
